...
---Adds a category filter for engravings.<br>
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Engraving.AddCategoryFilter)
---@param category number The category to filter by.
...
---Clears all category filters.<br>
...
---Clears the exclusive category filter.<br>
...
---Returns the exclusive category filter.<br>
...
---Retrieves the number of runes known, optionally for a specified equipment slot.<br>
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Engraving.GetNumRunesKnown)
---@param equipmentSlot number? Optional equipment slot index for querying the rune count.
---@return number known number of runes known.
---@return number max maximum number of runes available.
...
---@param shouldFilter boolean boolean
---@param ownedOnly boolean boolean
...
---Refreshes the list of runes.<br>
