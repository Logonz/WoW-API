...
---Returns information about the specified toon of a RealID friend.<br>
---[Documentation](https://warcraft.wiki.gg/wiki/API_BNGetFriendGameAccountInfo)
---@param bnetIDGameAccount number A unique numeric identifier for the friend during this session.
---@return boolean hasFocus Whether or not this toon is the one currently being displayed in Blizzard's FriendFrame.
---@return string characterName The name of the logged in toon/character.
---@return string client Either "WoW" (BNET_CLIENT_WOW), "S2" (BNET_CLIENT_S2), "WTCG" (BNET_CLIENT_WTCG), "App" (BNET_CLIENT_APP), "Hero" (BNET_CLIENT_HEROES), "Pro" (BNET_CLIENT_OVERWATCH), "CLNT" (BNET_CLIENT_CLNT), or "D3" (BNET_CLIENT_D3) for World of Warcraft, StarCraft 2, Hearthstone, BNet Application, Heroes of the Storm, Overwatch, another client, or Diablo 3.
---@return string realmName The name of the logged in realm.
...
---@return boolean isGameAFK
---@return boolean isGameBusy
function BNGetGameAccountInfo(bnetIDGameAccount) end
...
---Returns information on the game the Battle.net friend is playing.<br>
---[Documentation](https://warcraft.wiki.gg/wiki/API_BNGetGameAccountInfoByGUID)
---@param id number gameAccountInfo.gameAccountID
---@return BNetGameAccountInfo? gameAccountInfo
